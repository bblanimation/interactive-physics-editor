...
updater.addon = "interactive_physics_editor"
...
def register(bl_info):
	...
	updater.repo = "interactive_physics_editor"

	#updater.addon = # define at top of module, MUST be done first

	# Website for manual addon download, optional but recommended to set
	updater.website = "https://github.com/bblanimation/interactive_physics_editor/"
