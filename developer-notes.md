* Add Features
    * Lock the location in the objects' Normal direction which would allow droplets to stay on the surface of a can or bottle when they are repelling each other (User requested)
